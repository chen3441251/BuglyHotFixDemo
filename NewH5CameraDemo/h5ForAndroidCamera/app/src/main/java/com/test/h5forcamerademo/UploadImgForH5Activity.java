package com.test.h5forcamerademo;
...
import com.ddcash.h5cameralib.DDcashWebChromeClient;
...
public class UploadImgForH5Activity extends Activity {
    ...
    private String url = "http://coredev.ddcash.cn/#/guide?channel=souyijieh5";
    ...
    private void initData() {
        ...
        mWebView.setWebChromeClient(new MyWebChromeClient(this,url));
//                mWebView.setWebChromeClient(new DDcashWebChromeClient(this));
//        DDcashCameraHelper.getInstance().setDdcashH5Listenner(new DDcashCameraHelper.ddcashInterface() {
//            @Override
//            public void setFileChooser(Activity activity) {
//
//            }
//        });
    }
    ...
    public class MyWebChromeClient extends DDcashWebChromeClient {


        public MyWebChromeClient(Activity activity, String url) {
            super(activity, url);
        }
        ...
        @Override
        public void onCustomShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
        }

        @Override
        public void openCustomFileChooser(ValueCallback<Uri> filePathCallback) {

        }

        @Override
        public void openCustomFileChooser(ValueCallback filePathCallback, String acceptType) {

        }

        @Override
        public void openCustomFileChooser(ValueCallback<Uri> filePathCallback, String acceptType, String capture) {
